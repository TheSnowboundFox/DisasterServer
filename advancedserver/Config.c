...
bool config_init(void)
{
    ...
    g_config.lobby_ready_required_percentage = cJSON_GetObjectItem(lobby_misc, "lobby_ready_required_percentage")->valueint;
    g_config.kick_unready_before_starting = cJSON_IsTrue(cJSON_GetObjectItem(lobby_misc, "kick_unready_before_starting"));
    ...
    g_config.exe_camp_penalty = cJSON_IsTrue(cJSON_GetObjectItem(gameplay, "exe_camp_penalty"));
    g_config.anonymous_mode = cJSON_IsTrue(cJSON_GetObjectItem(gameplay, "anonymous_mode"));
    g_config.enable_achievements = cJSON_IsTrue(cJSON_GetObjectItem(gameplay, "enable_achievements"));
    g_config.enable_sounds = cJSON_IsTrue(cJSON_GetObjectItem(gameplay, "enable_sounds"));
    ...
    cJSON *character_specific = cJSON_GetObjectItem(json, "character_specific");

    cJSON *tails = cJSON_GetObjectItem(character_specific, "tails");

    g_config.tails_projectile_speed = cJSON_GetObjectItem(tails, "tails_projectile_speed")->valueint;
    g_config.tails_projectile_timeout_timer = cJSON_GetObjectItem(tails, "tails_projectile_timeout_timer")->valueint;
...
bool config_save(void)
{
    ...
    cJSON_AddNumberToObject(lobby_misc, "lobby_ready_required_percentage", g_config.lobby_ready_required_percentage);
    cJSON_AddBoolToObject(lobby_misc, "kick_unready_before_starting", g_config.kick_unready_before_starting);
    ...
    cJSON_AddBoolToObject(gameplay, "exe_camp_penalty", g_config.exe_camp_penalty);
    cJSON_AddBoolToObject(gameplay, "anonymous_mode", g_config.anonymous_mode);
    cJSON_AddBoolToObject(gameplay, "enable_achievements", g_config.enable_achievements);
    cJSON_AddBoolToObject(gameplay, "enable_sounds", g_config.enable_sounds);
    ...
    cJSON_AddNumberToObject(tails, "tails_projectile_speed", g_config.tails_projectile_speed);
    cJSON_AddNumberToObject(tails, "tails_projectile_timeout_timer", g_config.tails_projectile_timeout_timer);
    cJSON_AddItemToObject(character_specific, "tails", tails);

    cJSON_AddItemToObject(json, "character_specific", character_specific);
